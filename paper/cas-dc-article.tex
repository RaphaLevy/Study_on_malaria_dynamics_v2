...
\\\\
In order to use the latest and complete avaliable data on registered cases and deforestation and forest fires noticed, this study was done using data from 2016 to 2024, but limited to the years of 2017 to 2023, given that the SIVEP database didn't include registered data from 2024 at the time of development of this study. 
