...
\captionof{figure}{Results of the initial SIR model, with equations and parameters from \cite{Parham2010}.}
\label{FIG:1A}
...
\captionof{figure}{Results of the initial SEI model, with equations and parameters from \cite{Parham2010}.}
\label{FIG:2A}
...
\captionof{figure}{Results of the initial SEI model, with equations and parameters from \cite{Parham2010}, ensuring that probabilities and rates are in $[0,1]$.}
\label{FIG:3A}
