...
\section{Results}
The initial modelling, using the original equations and parameters as defined in \cite{Parham2010} did not appear to properly reproduce the expected behavior of disease transmission especially in the case of the mosquito population, as can be seen in Figure 2A.
