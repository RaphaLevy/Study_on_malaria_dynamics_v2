...
\\\\
With this process, it was noted some inconsistencies on the data of the project: firstly, that the rural and urban incidences of the period 2015-2019 were incorrectly calculated using the 
respective populations on the period of 2004-2008, which was later changed, in order to have the appropriate incidences to the given time period; and that the rural and urban populations 
from 2006 and 2017 were estimated using the same ratio as that of 2010. In order to take into consideration the given data from 2000 and the change in population growth, especially
when considering urbanization, the rural population of 2006 was taken as an approximate mean between the populations from 2000 to 2010, while the latter was extrapolated in order to estimate data for 2017, 
taking into consideration the years between them. 
