...
\begin{align}
\dfrac{dS_H}{dt} & = \mu_HN-ab_2\left(\dfrac{I_M}{N}\right)S_H  \label{eq7}\\ %- \mu_HS_H \label{eq1}\\ %\dfrac{dS_H}{dt} & = -ab_2\bigg(\dfrac{I_M}{N}\bigg)S_H \label{eq1}\\
...
R_H(t) & = \max\left(0, \ N (1+\mu_H t) -S_H(t) -I_H(t)\right)\label{eq14}
\end{align}
\\
...
\includegraphics[width=1.0\columnwidth]{figs/comparison-between-IH-data-and-model.png}

\captionof{figure}{Ex.: Comparison between observed data of infections and model estimation of $I_H$.}
\label{FIG:1A}
